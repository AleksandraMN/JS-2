...
let a = Number(prompt('Введите любое корректное положительное целое число', '0'));

alert(`В числе ${a} количество сотен: ${Math.floor((a/100)%10)}, десятков: ${Math.floor((a/10)%10)}, единиц: ${a%10}`);
